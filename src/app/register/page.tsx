  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-8 sm:py-12">
      <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        <h1 className="mb-6 text-center text-2xl font-bold text-gray-900">Rekisteröidy</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700">Salasana</label>
            <input
              type="password"
              value={password}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700">Vahvista salasana</label>
            <input
              type="password"
